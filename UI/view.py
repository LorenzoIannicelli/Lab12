...
class View:
    ...
    def load_interface(self):
        ...
        self.pulsante_cammino_minimo = ft.ElevatedButton('Cammino Minimo', width=400,
                                                         on_click=self.controller.handle_cammino_minimo
                                                         if self.controller.checkGraph else self.show_alert('Creare prima il grafo!'))
